...
export const Welcome: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden p-6 bg-gradient-to-br from-purple-700 via-indigo-950 to-slate-950">
       ...
       <div className="max-w-5xl w-full text-center space-y-8 z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 pt-4">
              <Link 
                to="/generate" 
                className="group relative px-8 py-4 bg-white text-purple-950 font-bold rounded-2xl hover:scale-105 transition-all duration-300 flex items-center gap-2 shadow-[0_0_40px_-10px_rgba(255,255,255,0.5)] hover:shadow-[0_0_60px_-15px_rgba(255,255,255,0.6)]"
              >
                 Start Creating
              ...
              <Link 
                to="/samples" 
                className="px-8 py-4 bg-purple-900/30 text-white font-medium rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm"
              >
                 View Gallery
              </Link>
          </div>
          ...
          {/* Feature Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 text-left animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
